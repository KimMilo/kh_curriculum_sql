...
---------- JOB_TITLE 한글 번역하여 수정하기-------------------------------
UPDATE KJOBS SET JOB_TITLE = '회장' WHERE JOB_TITLE = 'President';
UPDATE KJOBS SET JOB_TITLE = '관리부서장' WHERE JOB_TITLE = 'Administration Vice President';
UPDATE KJOBS SET JOB_TITLE = '관리보조' WHERE JOB_TITLE = 'Administration Assistant';
UPDATE KJOBS SET JOB_TITLE = '재무관리자' WHERE JOB_TITLE = 'Finance Manager';
UPDATE KJOBS SET JOB_TITLE = '회계사' WHERE JOB_TITLE = 'Accountant';
UPDATE KJOBS SET JOB_TITLE = '회계관리자' WHERE JOB_TITLE = 'Accounting Manager';
UPDATE KJOBS SET JOB_TITLE = '공인회계사' WHERE JOB_TITLE = 'Public Accountant';
UPDATE KJOBS SET JOB_TITLE = '영업관리자' WHERE JOB_TITLE = 'Sales Manager';
UPDATE KJOBS SET JOB_TITLE = '영업담당자' WHERE JOB_TITLE = 'Sales Representative';
UPDATE KJOBS SET JOB_TITLE = '구매담당자' WHERE JOB_TITLE = 'Purchasing Manager';
UPDATE KJOBS SET JOB_TITLE = '구매사무원' WHERE JOB_TITLE = 'Purchasing Clerk';
UPDATE KJOBS SET JOB_TITLE = '재고관리자' WHERE JOB_TITLE = 'Stock Manager';
UPDATE KJOBS SET JOB_TITLE = '재고담당자' WHERE JOB_TITLE = 'Stock Clerk';
UPDATE KJOBS SET JOB_TITLE = '배송담당자' WHERE JOB_TITLE = 'Shipping Clerk';
UPDATE KJOBS SET JOB_TITLE = '개발자' WHERE JOB_TITLE = 'Programmer';
UPDATE KJOBS SET JOB_TITLE = '마케팅매니저' WHERE JOB_TITLE = 'Marketing Manager';
UPDATE KJOBS SET JOB_TITLE = '마케팅담당자' WHERE JOB_TITLE = 'Marketing Representative';
UPDATE KJOBS SET JOB_TITLE = '인적자원담당자' WHERE JOB_TITLE = 'Human Resources Representative';
UPDATE KJOBS SET JOB_TITLE = '홍보담당자' WHERE JOB_TITLE = 'Public Relations Representative';

SELECT * FROM KJOBS;

/*
 * DEPARTMENTS 테이블에 DEPARTMENT_NAME_KR 컬럼을 추가 후 DEPARTMENT_NAME 을 
 * 한글로 번역한 데이터가 수정되게 한다.
 */


ALTER TABLE DEPARTMENTS ADD DEPARTMENT_NAME_KR VARCHAR(20 CHAR);
...
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '구매부' WHERE DEPARTMENT_NAME = 'Purchasing';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '인사부' WHERE DEPARTMENT_NAME = 'Human Resources';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '배송부' WHERE DEPARTMENT_NAME = 'Shipping';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = 'IT부' WHERE DEPARTMENT_NAME = 'IT';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '섭외부' WHERE DEPARTMENT_NAME = 'Public Relations';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '영업부' WHERE DEPARTMENT_NAME = 'Sales';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '경영관리부' WHERE DEPARTMENT_NAME = 'Executive';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '재무부' WHERE DEPARTMENT_NAME = 'Finance';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '회계부' WHERE DEPARTMENT_NAME = 'Accounting';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '자금부' WHERE DEPARTMENT_NAME = 'Treasury';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '법인세부' WHERE DEPARTMENT_NAME = 'Corporate Tax';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '통제신용' WHERE DEPARTMENT_NAME = 'Control And Credit';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '주주서비스' WHERE DEPARTMENT_NAME = 'Shareholder Services';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '이익관리부' WHERE DEPARTMENT_NAME = 'Benefits';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '조직관리부' WHERE DEPARTMENT_NAME = 'Manufacturing';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '건설부' WHERE DEPARTMENT_NAME = 'Construction';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '계약관리부' WHERE DEPARTMENT_NAME = 'Contracting';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '운영부' WHERE DEPARTMENT_NAME = 'Operations';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = 'IT지원부' WHERE DEPARTMENT_NAME = 'IT Support';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '운영센터' WHERE DEPARTMENT_NAME = 'NOC';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = 'IT고객센터' WHERE DEPARTMENT_NAME = 'IT Helpdesk';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '정부영업부' WHERE DEPARTMENT_NAME = 'Government Sales';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '고객영업부' WHERE DEPARTMENT_NAME = 'Retail Sales';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '인원모집부' WHERE DEPARTMENT_NAME = 'Recruiting';
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '급여관리부' WHERE DEPARTMENT_NAME = 'Payroll';
   
-----------------------------------------------------------------------------------------------

SELECT 'UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '' WHERE DEPARTMENT_ID = ' || DEPARTMENT_ID
  FROM DEPARTMENTS;
...
UPDATE DEPARTMENTS SET DEPARTMENT_NAME_KR = '통제와신용' WHERE DEPARTMENT_ID = 140;
...
/*
 * KJOBS 테이블에 한글로 번역한 직무 타이틀을 JOBS 테이블에 JOB_TITLE_KR 컬럼으로
 * 추가 후 수정되도록 한다. (DEPARTMENTS 테이블처럼 하나의 테이블에 영문/한글이 모두 들어가게한다.)
 * 모든 작업을 완료 후 KJOBS 테이블은 제거한다.
 */

ALTER TABLE JOBS ADD JOB_TITLE_KR VARCHAR(20 CHAR);
...
INSERT INTO JOBS VALUES ('SV_MGR', 'Server Manager', 4000, 10000, '서버 관리자');
INSERT INTO JOBS VALUES ('SV_ENG', 'Server Engineer', 6000, 12000, '서버 엔지니어');
INSERT INTO JOBS VALUES ('NT_MGR', 'Network Manager', 5000, 11000, '네트워크 관리자');
...
INSERT INTO DEPARTMENTS VALUES(280, 'Server', NULL, 3000, '서버관리부' );
INSERT INTO DEPARTMENTS VALUES(290, 'Network', NULL, 3000, '네트워크관리부' );
...
UPDATE EMPLOYEES SET MANAGER_ID = 208 WHERE EMPLOYEE_ID IN(209,210);
UPDATE EMPLOYEES SET MANAGER_ID = 211 WHERE EMPLOYEE_ID IN(211,212);
...
/*
 * 100번 사원이 공지를 열람한다는 가정하에 100번 사원이 소속된 부서의 공지와 전체공지가
 ...
 * 수정하도록 한다.
 * 		- 중요도는 1 ~ 5 까지 사용할 수 있다.
 * 		- 1:매우중요, 2:중요, 3:보통, 4:중요하진않음, 5:확인은할것
 *		- 중요도를 성정하지 않으면 기본 3으로 저장되게 한다.
...
/* DEPARTMENTS 테이블에서 MANAGER_ID 가 없는 부서 제거*/
DELETE 
  FROM DEPARTMENTS
 WHERE MANAGER_ID IS NULL;


/* NOTICE 테이블에서 삭제 부서의 공지사항 제거*/
DELETE
  FROM (SELECT DEPT_ID FROM NOTICE N
          LEFT OUTER JOIN DEPARTMENTS D
            ON N.DEPT_ID = D.DEPARTMENT_ID
         WHERE N.DEPT_ID <> 0
...
/*
 * EMPLOYEES 테이블의 DEPARTMENT_ID 가 없는 사원은 MANAGER_ID 에 해당하는 사원 정보를 찾아서
 * 해당 사원의 DEPARTMENT_ID 값이 EMPLOYEES 테이블의 DEPARTMENT_ID 가 되도록 수정한다.
 */
...
UPDATE EMPLOYEES E1
   SET E1.DEPARTMENT_ID = (SELECT DEPARTMENT_ID
   							 FROM EMPLOYEES E2
